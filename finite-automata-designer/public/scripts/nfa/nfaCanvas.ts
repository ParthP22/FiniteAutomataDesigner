...
function setupNfaCanvas(canvas: HTMLCanvasElement, signal: AbortSignal) {
...
function attachWhenReady() {
  ...
  const observer = new MutationObserver(() => {
    const el = document.getElementById('NFACanvas') as HTMLCanvasElement | null;
  ...
  const existing = document.getElementById('NFACanvas') as HTMLCanvasElement | null;
  if (existing) {
